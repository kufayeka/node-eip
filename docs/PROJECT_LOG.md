> **This is the project's historical investigation log** — a snapshot of
> `README.md` before it was restructured (2026-09) around a formal ODVA
> compliance checklist (see the new `README.md` and `README_GOAL.md`).
> Kept because it has the full, dated narrative of every live-hardware
> finding, bug, and dead end this project has been through — none of that
> detail was worth losing, it just doesn't belong in the top-level README
> anymore. The new `README.md` is the authoritative compliance/status
> reference; this file is for "how did we find that out" context.
